...
// v23.1.92 icon lock: layer shapes are stable and unique; basemap changes may change colors only.
ICONS.hookup='<svg viewBox="0 0 24 24"><path fill="currentColor" d="M8 2h2v6h4V2h2v6h1.5c.8 0 1.5.7 1.5 1.5V13c0 2.4-1.7 4.4-4 4.9V22h-3v-4.1c-2.3-.5-4-2.5-4-4.9V9.5C8 8.7 8.7 8 9.5 8H11V2h2v6h1V2h2v7.8H8V2Zm2 9.8V13c0 1.7 1.3 3 3 3s3-1.3 3-3v-1.2h-6Z"/></svg>';
ICONS.treeWater='<svg viewBox="0 0 24 24"><path fill="currentColor" d="M12 2.5 15.5 7h-1.8l3.1 4h-2.1l2.7 3.5h-3.6v2.2h-3.6v-2.2H6.6L9.3 11H7.2l3.1-4H8.5L12 2.5Zm4.4 13.5c1.1 0 2 .3 2.9.8l-.8 1.4c-.7-.3-1.3-.5-2.1-.5-1.1 0-1.8.5-2.5 1-.8.6-1.7 1.2-3.1 1.2s-2.3-.6-3.1-1.2c-.7-.5-1.3-1-2.5-1-.7 0-1.4.2-2 .5l-.8-1.4c.9-.5 1.8-.8 2.9-.8 1.6 0 2.6.7 3.4 1.3.7.5 1.2.9 2.1.9s1.4-.4 2.1-.9c.8-.6 1.8-1.3 3.5-1.3Zm.2 3.4c.8 0 1.5.2 2.2.5l-.7 1.3c-.5-.2-.9-.3-1.5-.3-.8 0-1.2.3-1.8.7-.7.5-1.5 1-2.8 1s-2.1-.5-2.8-1c-.6-.4-1-.7-1.8-.7-.5 0-1 .1-1.5.3l-.7-1.3c.7-.3 1.4-.5 2.2-.5 1.3 0 2.1.5 2.8 1 .6.4 1 .7 1.8.7s1.2-.3 1.8-.7c.7-.5 1.5-1 2.8-1Z"/></svg>';
const LAYERS=[
 ...
 {key:'modern',label:'Modern campgrounds',css:'pin-modern',icon:ICONS.hookup},
 {key:'private',label:'Private campgrounds',css:'pin-private',icon:ICONS.camper},
 {key:'boat-backpack',label:'Boat / Backpack',css:'pin-boat-backpack',icon:ICONS.treeWater},
