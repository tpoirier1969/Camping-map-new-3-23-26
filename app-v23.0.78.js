...
function startLiveLocation(force=false){
  ...
  app.liveLocationWatchId=navigator.geolocation.watchPosition(pos=>{
    const c=pos.coords||{};
    applyNearMeLocation(c.latitude,c.longitude,c.accuracy,{nearMe:manualNearMe,forceReload:manualNearMe&&!app.liveLocationLastLoadCenter}).catch(e=>{console.error(e);setLoading(false);notify('Could not update your live location.')});
  },err=>{
