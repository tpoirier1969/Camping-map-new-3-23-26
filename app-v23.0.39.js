...
const app={map:null,markerLayer:null,userMarker:null,draftMarker:null,baseLayers:{},sites:[],shownSites:[],stateData:{},enabledStates:new Set(),enabledLayers:new Set(),filters:{},draftPoint:null,draftQueue:[],supabase:null,session:null,restRoadsideStats:null,localAreaCenter:null,restOnlyMode:false};
...
function layerKey(site){
  ...
  // v23.0.39: boat/backpack access gets its own layer. Primitive alone is not enough; it can remain Rustic or Boondocking depending on the site.
...
const NEAR_ME_RADIUS_MILES=200;
