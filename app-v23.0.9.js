...
async function loadMdotLiveRestRoadside(code){
  ...
  try{
    ...
    window.CAMPING_MD0T_LIVE_REST_ROADSIDE_COUNT=combined.length;
    return combined;
  }catch(err){
    ...
    try{
      ...
      return (window.CAMPING_MI_REST_ROADSIDE_SUPPLEMENT||[]).map(function(site){
