...
function buildControls(){buildStateSelect(); buildLayerList(); buildLegend(); syncFilters(); bindEvents(); updatePendingMeta(); syncRouteControls(); updateAreaOutlinePanel();}
...
function areaOutlineArcgisUrl(outline){
  ...
  return addQueryParams(url,{where,outFields:outline.outFields||'*',returnGeometry:'true',f:'geojson'});
}
