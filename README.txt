...
Recovery build v20.5.9.5:
- Added .nojekyll for GitHub Pages
- Embedded campsite and zone data in js/inline-data.js so local file launch does not depend on fetch() for data
- Default basemap now starts on OSM fallback unless you choose/save another basemap
