(function(){
  ...
  const campingRules='https://www.michigan.gov/dnr/things-to-do/camping-and-lodging/backpack';
  const forestMap='https://midnr.maps.arcgis.com/apps/webappviewer/index.html?id=2c8a3ec72f3449258678c2a1c5de7e1f';
  const projectMap='https://experience.arcgis.com/experience/65fb1a70f0794cbfa25e0e0a250f9caf';
  const records=[
    {
      id:'mi-dnr-state-forest-land-v231105',
      ...
      layerNameHints:['state forest land','state forest ownership','state forest'],
      layerNameRejects:['project boundary','campground','state park','game area','wildlife','trail','roads'],
      sourceName:'Michigan DNR — Map of state forests and campgrounds',
      sourceUrl:forestMap,
      rulesSourceUrl:campingRules,
      boundaryRepresents:'Official Michigan DNR state-forest-land geometry discovered from the DNR state forest map and loaded only for the visible Michigan map area.',
      ...
      style:{color:'#365f45',weight:1.5,opacity:.82,fillColor:'#6c9276',fillOpacity:.08,dashArray:'7 5'},
      suppressLabels:true
    },
    {
      id:'mi-craig-lake-backcountry-area-v231105',
      ...
      layerNameHints:['project boundaries','state park project boundaries','park and recreation area boundaries','state park boundaries'],
      layerNameRejects:['forest project','game area','wildlife area'],
      targetNames:['Craig Lake'],
      queryEnvelope:[-88.35,46.42,-87.92,46.72],
      sourceName:'Michigan DNR project boundaries and backcountry camping guidance',
      sourceUrl:projectMap,
      rulesSourceUrl:campingRules,
      ...
      rulesDetails:['Use official designated or reservable backcountry campsites only.','Do not treat the park/project boundary as permission to camp anywhere inside it.','Remove or suppress this area after the designated campsite set is completely mapped as individual points.'],
      style:{color:'#55724e',weight:2,opacity:.9,fillColor:'#91a887',fillOpacity:.09,dashArray:'6 4'}
    },
    {
      id:'mi-porkies-backcountry-area-v231105',
      ...
      layerNameHints:['project boundaries','state park project boundaries','park and recreation area boundaries','state park boundaries'],
      layerNameRejects:['forest project','game area','wildlife area'],
      targetNames:['Porcupine Mountains'],
      queryEnvelope:[-90.08,46.62,-89.42,47.02],
      sourceName:'Michigan DNR project boundaries and backcountry camping guidance',
      sourceUrl:projectMap,
      rulesSourceUrl:campingRules,
      coverageStatus:'incomplete',
      ...
      recommendedUse:'context-until-sites-complete',
      rulesDetails:['Use official designated/reservable backcountry campsites, cabins, or yurts only as current park rules allow.','Do not treat the park/project boundary as permission to camp anywhere inside it.','Suppress this area after the designated backcountry system is completely represented by individual map records.'],
      style:{color:'#55724e',weight:2,opacity:.9,fillColor:'#91a887',fillOpacity:.09,dashArray:'6 4'}
    },
    {
      id:'mi-tahquamenon-backcountry-area-v231105',
      ...
      layerNameHints:['project boundaries','state park project boundaries','park and recreation area boundaries','state park boundaries'],
      layerNameRejects:['forest project','game area','wildlife area'],
      targetNames:['Tahquamenon Falls'],
      queryEnvelope:[-85.55,46.43,-84.92,46.74],
      sourceName:'Michigan DNR project boundaries and backcountry camping guidance',
      sourceUrl:projectMap,
      rulesSourceUrl:campingRules,
      coverageStatus:'incomplete',
      ...
      recommendedUse:'context-until-sites-complete',
      rulesDetails:['Use only official designated/reservable backcountry sites.','Do not treat the park/project boundary as permission to camp anywhere inside it.','Suppress this area after the designated backcountry campsite set is completely mapped.'],
      style:{color:'#55724e',weight:2,opacity:.9,fillColor:'#91a887',fillOpacity:.09,dashArray:'6 4'}
    },
    {
      id:'mi-wilderness-state-park-backcountry-area-v231105',
      ...
      layerNameHints:['project boundaries','state park project boundaries','park and recreation area boundaries','state park boundaries'],
      layerNameRejects:['forest project','game area','wildlife area'],
      targetNames:['Wilderness State Park','Wilderness'],
      queryEnvelope:[-85.18,45.62,-84.70,45.90],
      sourceName:'Michigan DNR project boundaries and backcountry camping guidance',
      sourceUrl:projectMap,
      rulesSourceUrl:campingRules,
      coverageStatus:'incomplete',
  ...
  window.MI_BACKCOUNTRY_AREA_COVERAGE_V231105={
