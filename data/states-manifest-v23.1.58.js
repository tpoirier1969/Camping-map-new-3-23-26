window.CAMPING_STATES_MANIFEST = {
  ...
  "MN": {
    ...
    "dynamicSources": [
      ...
      "v23.1.58: Minnesota western closeout active batch adds 30 supervisor-tightened records from Workers 3, 5, and 6: 14 Modern Campgrounds, 15 Rustic / Primitive records, and 1 Boat / Backpack walk-in campground. Timm Park uses Tod-supplied corrected campground coordinate 44.6954283441916,-95.52287655303293. Rows without safe coordinates remain in data/leads.js instead of becoming active pins."
    ]
  },
  "MS": {
    "code": "MS",
