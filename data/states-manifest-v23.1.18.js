// Camping Map states manifest v23.1.18 Wisconsin grid-pass safe adds
window.CAMPING_STATES_MANIFEST = {
  ...
  "MI": {
    ...
    "dynamicSources": [
      ...
      "v23.0.84: corrected/refreshed Hiawatha exact rustic/primitive backlog records and added missing Indian River, Hemlock, and Channel Marker exact official records"
    ]
  },
  "MN": {
    "code": "MN",
    ...
    "dynamicSources": [
      ...
      "v23.1.15: added 14 official Superior National Forest rustic/backcountry system records as Rustic / Primitive seed import records."
    ]
  },
  "MS": {
    "code": "MS",
  ...
  "WI": {
    ...
    "dynamicSources": [
      ...
      "v23.1.16: added 4 official CNF Rustic / Primitive campground system records and 2 verified county-forest Boondocking / Dispersed rule-area records; held McCaslin, Anvil duplicate, NHAL duplicate, and unresolved county/DNR leads out of active import.",
      "v23.1.17: added 15 official Chequamegon-Nicolet NF north-central/northwest Rustic / Primitive campground system points for the Clam Lake, Glidden, Mellen, Cable, Drummond, Bayfield County, Mondeaux, Park Falls/Fifield, Hayward and Lac du Flambeau travel band.",
      "v23.1.18: statewide grid-pass safe adds: 52 exact NPS Apostle Islands Boat / Backpack campsite/group-site points, 2 additional official CNF Rustic / Primitive system points, 3 Vilas County Rustic / Primitive campground points, and 3 Governor Knowles State Forest Rustic / Primitive campground system points; held unresolved rule-area/geometry and suspect duplicate-coordinate rows."
    ]
  },
  "WY": {
    "code": "WY",
