(function(){
  ...
  const records=[
  {
    "id": "mi-dnr-state-forest-land-v231109",
    ...
    "allowGlobalPortalFallback": true,
    "parseEmbeddedItemJson": true,
  ...
  {
    "id": "mi-craig-lake-backcountry-area-v231109",
  ...
  {
    "id": "mi-porkies-backcountry-area-v231109",
  ...
  {
    "id": "mi-tahquamenon-backcountry-area-v231109",
    ...
    "coverageNote": "v23.1.114 maps all three official designated Tahquamenon backcountry campsites as exact individual Boat / Backpack points, so this redundant broad project-boundary outline is suppressed by the designated-site coverage rule.",
    ...
    "exactCampingBoundary": false,
    "officialCampingLegality": "Backcountry camping is limited to the three official designated/reservable sites now mapped as individual Boat / Backpack points. The broad project-boundary outline is suppressed because it no longer adds necessary campsite coverage.",
    ...
    "recommendedUse": "suppressed-after-complete-site-set",
    "rulesDetails": [
  ...
  {
    "id": "mi-wilderness-state-park-backcountry-area-v231109",
