...
window.CAMPING_STATES_MANIFEST = {
  ...
  "MT": {"code":"MT","name":"Montana","file":"data/states/MT.js","count":75,"files":["data/states/MT.js","data/supplements/modern-audit-cleanup-v23.1.21.js","data/supplements/mt-exact-build-batch1-v23.1.28.js"],"dynamicSources":["v23.1.21: Modern criteria audit cleanup supplement applied; moves proven non-Modern rows out of Modern and sends unproven rows to Needs Verification.","v23.1.28: Montana exact official-source build batch 1 adds 70 high-confidence campground/site records from the six-worker Montana proof pass; broad area/rule candidates and blocked extraction leads held for follow-up extraction passes."]},
